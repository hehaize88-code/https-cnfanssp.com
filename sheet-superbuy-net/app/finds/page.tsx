...
export const metadata: Metadata = { title: "Superbuy Finds 2026: Shoes, Hoodies, Jackets & More", description: "Browse curated Superbuy finds with current product links, USD reference prices, option checks and QC notes for shoes, hoodies, jackets and accessories.", alternates: { canonical: "/finds/" } };
