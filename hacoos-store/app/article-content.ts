    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Platform-level ratings answer a different question. Google Play and Trustpilot provide context about the overall service, not proof about a particular hoodie or pair of shoes. At the time of research, Google Play displayed a 4.1 rating with roughly 57,700 reviews, while Trustpilot displayed 3.6 from 3,267 reviews and described mixed themes around quality, delivery, cancellations and refunds. The difference itself is a warning not to compress thousands of experiences into a single promise.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "The wider rating picture is mixed. On 27 August 2026, Google Play showed a 4.1 rating and around 57,700 reviews, while Trustpilot showed 3.6 from 3,267 reviews. Trustpilot's own summary described mixed experiences across product quality, delivery and orders, with negative discussion around refunds. These figures should not be averaged into a verdict. They come from different audiences and moderation systems; use them to identify questions, then answer those questions with current item-level evidence.",
        ],
      },
      {
  ...
  const data: Record<Exclude<Locale, "en">, Record<ArticleKey, Article>> = {
    ...
    fr: {
      "articles/find-product-links": { minutes: 9, sections: [
        ...
        { heading: "Utiliser correctement les avis", paragraphs: ["Hacoo met en avant notes et avis dans son modèle de confiance. Les photos récentes et mesures sont utiles, mais peuvent concerner une autre variante.", "Google Play affichait 4,1 avec environ 57 700 avis; Trustpilot 3,6 avec 3 267 avis et des thèmes partagés sur qualité, livraison, annulations et remboursements. Une note de plateforme ne prouve rien sur un article précis."] },
