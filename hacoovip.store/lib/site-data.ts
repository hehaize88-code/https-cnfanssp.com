...
export const copy: Record<Locale, Record<string, string>> = {
  en: {
    ...
    heroTitle: "Hacoo Spreadsheet, Links and App Facts to Check in 2026",
    heroBody:
      "Browse an independent Hacoo spreadsheet, verify live product links, and check photos, shipping, returns and current app facts before opening a product route.",
  ...
  de: {
    ...
    heroTitle: "Hacoo-Tabelle, Links und App-Fakten für 2026",
    heroBody: "Durchsuche eine unabhängige Hacoo-Tabelle, prüfe Live-Produktlinks sowie Fotos, Versand, Rückgaben und aktuelle App-Fakten, bevor du eine Produktroute öffnest.",
  ...
  es: {
    ...
    heroTitle: "Hoja Hacoo, enlaces y datos de la app para 2026",
    heroBody: "Explora una hoja Hacoo independiente, verifica enlaces activos y revisa fotos, envíos, devoluciones y datos actuales de la app antes de abrir una ruta de producto.",
  ...
  fr: {
    ...
    heroTitle: "Tableur Hacoo, liens et faits sur l’app en 2026",
    heroBody: "Parcourez un tableur Hacoo indépendant, vérifiez les liens actifs, les photos, la livraison, les retours et les faits actuels sur l’app avant d’ouvrir une fiche produit.",
  ...
  it: {
    ...
    heroTitle: "Foglio Hacoo, link e dati dell’app da verificare nel 2026",
    heroBody: "Consulta un foglio Hacoo indipendente, verifica link attivi, foto, spedizioni, resi e dati aggiornati dell’app prima di aprire un percorso prodotto.",
