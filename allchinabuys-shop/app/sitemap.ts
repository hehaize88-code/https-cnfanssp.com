...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...["/spreadsheet", "/finds", "/articles", "/guides/how-to-use", "/guides/qc-checks", "/guides/shipping", "/faq"].map((path) => ({ url: `${base}${path}`, lastModified: updated, changeFrequency: "monthly" as const, priority: path === "/spreadsheet" ? .9 : .7 })),
