...
export default async function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const relatedGuide = seoArticles.find((article) => article.categorySlug === slug || (slug === "headwear" && article.slug.includes("accessories")));
