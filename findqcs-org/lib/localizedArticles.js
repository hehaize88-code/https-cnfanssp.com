...
const ENGLISH_UI = {
  ...
  journalNote: "Six original, practical guides connect product discovery, mapped-index navigation, warehouse evidence and parcel planning. Images are editorial examples, not inspection records for a buyer's order.",
