# ACBuy Finds & QC Guide

Production source for `acbuys.shop`. The site includes the catalog homepage,
Guide, QC, Shipping, FAQ, SEO article hub, four long-form articles, and the
complete EN/DE/FR/ES/IT/PL language module.
...
- The catalog hero image is stored as a validated, optimized PNG asset.
