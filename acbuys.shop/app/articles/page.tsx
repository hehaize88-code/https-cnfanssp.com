...
export default function ArticlesPage() {
  return <InfoPage accent="blue" eyebrow="SEO articles" title="Useful ACBuy research, written for real shopping decisions." intro="This article hub targets the questions people search before ordering. Every topic is separated by intent, grounded in current platform information, and linked to a practical next step." sections={[
