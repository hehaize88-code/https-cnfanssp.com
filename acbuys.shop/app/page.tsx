...
export default function Home() {
  const schema = {
    ...
    "@graph": [
      ...
      { "@type": "WebSite", "@id": "https://acbuys.shop/#website", name: "ACBuy Spreadsheet 2026 & Shopping Guides", url: "https://acbuys.shop/", publisher: { "@id": "https://acbuys.shop/#organization" }, inLanguage: "en" },
    ],
  };
