...
export const metadata: Metadata = { title: "ACBuy QC Photo Guide | 5-Point Warehouse Check", description: "Learn how to review ACBuy warehouse QC photos for shape, color, details, size, and visible defects." };

export default function QcPage() {
  return <InfoPage accent="coral" eyebrow="Warehouse inspection" title="Five checks before you accept warehouse QC." intro="QC photos are evidence, not decoration. Review them in a repeatable order so small details do not get lost in the excitement of a new arrival." sections={[
