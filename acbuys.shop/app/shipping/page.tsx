...
export const metadata: Metadata = { title: "ACBuy Shipping & Parcel Planning Guide", description: "Understand consolidation, chargeable weight, packaging, shipping estimates, restrictions, and parcel submission." };

export default function ShippingPage() {
  return <InfoPage accent="lime" eyebrow="Parcel planning" title="Plan the parcel before the parcel plans your budget." intro="International shipping depends on the destination, line, weight, dimensions, restrictions, and packaging choices. A useful guide explains those variables instead of publishing a fake universal price." sections={[
