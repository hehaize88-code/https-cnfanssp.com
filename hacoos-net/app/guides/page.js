...
export const metadata = createPageMetadata({ title: "Hacoo Finds Journal: Wardrobe & Listing Decisions", description: "Read product-led Hacoo finds guides covering wardrobe shortlists, category choices, listing verification, measurements and visual evidence.", path: "/guides", alternates: languageAlternates("/guides", "en") });
