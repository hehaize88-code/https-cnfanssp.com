...
export async function generateMetadata({params}:{params:Promise<{lang:string;slug?:string[]}>}):Promise<Metadata>{
  ...
  const activeShopArticle=page==="joyagoo-color-size-quantity-variant-check"||page==="joyagoo-title-thumbnail-destination-consistency-check"||page==="joyagoo-spreadsheet-independent-product-index-guide"||page==="joyagoo-destination-listing-verification-guide"||page==="joyagoo-product-id-source-link-destination-url-guide";
