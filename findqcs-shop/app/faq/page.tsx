...
export const metadata: Metadata = { title: "FindQC FAQ: Search, Premium QC, Reviews & Product Intelligence", description: "Clear answers about FindQC search methods, Premium QC, Product Intelligence, reviews, Real Hauls data and the limits of product evidence.", alternates: { canonical: `${PLANNED_ORIGIN}/faq` } };
