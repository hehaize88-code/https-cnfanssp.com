...
Independent Hacoo UK product-link, shipping, returns, QC and sizing guide.
The production site is built as a static Cloudflare Pages project from this
directory only.
...
- Root directory: `hacoos-uk`
- Build command: `npm run build:pages`
- Output directory: `dist/pages`
- Node.js: `22.13.0` or newer
- Pages project: `hacoos-uk`
- Canonical domain: `https://hacoos.uk`
...
- `npm run build`: build the Vinext server artifact
- `npm run build:pages`: build and export all canonical locale routes for Cloudflare Pages
