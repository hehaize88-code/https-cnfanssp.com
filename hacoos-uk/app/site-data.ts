...
export const copy: Record<Locale, Copy> = {
  en: {
    nav: { spreadsheet: "Spreadsheet", finds: "Finds", categories: "Categories", "qc-guide": "QC", shipping: "Shipping", guide: "Guide", articles: "Articles", faq: "FAQ" },
    badge: "Independent UK link desk · checked 28 Aug 2026",
    heroTitle: "Hacoo UK links you can verify before you buy.",
    heroText: "Find current product routes with matching first images, then use practical QC, sizing, shipping and returns guidance built for UK shoppers.",
    ...
    workflow: ["Choose a category or search term.", "Open the exact listing and match its image, ID and current options.", "Check QC, sizing, UK delivery and returns before deciding."],
    ...
    pageLabels: {
      home: { title: "Hacoo UK Product Links, Shipping & Buying Guide", intro: "Check current product links, matching first images, QC, sizing, UK delivery and returns in one independent guide." },
      spreadsheet: { title: "Hacoo Spreadsheet UK: Current Product Links", intro: "Use a searchable product-ID index to verify the destination, first image, option and source price before opening a listing." },
      finds: { title: "Current Hacoo UK Product Links", intro: "Source-matched routes with a current first image, product ID, source price and exact destination." },
      ...
      guide: { title: "How to Use Hacoo Product Links in the UK", intro: "A step-by-step route from discovery to listing verification, QC, sizing and delivery checks." },
  ...
  de: {
    nav: { spreadsheet: "Tabelle", finds: "Funde", categories: "Kategorien", "qc-guide": "QC", shipping: "Versand", guide: "Anleitung", articles: "Artikel", faq: "FAQ" },
  ...
  fr: {
    nav: { spreadsheet: "Tableur", finds: "Sélection", categories: "Catégories", "qc-guide": "QC", shipping: "Livraison", guide: "Guide", articles: "Articles", faq: "FAQ" },
  ...
  es: {
    nav: { spreadsheet: "Hoja", finds: "Hallazgos", categories: "Categorías", "qc-guide": "QC", shipping: "Envío", guide: "Guía", articles: "Artículos", faq: "FAQ" },
  ...
  it: {
    nav: { spreadsheet: "Foglio", finds: "Scoperte", categories: "Categorie", "qc-guide": "QC", shipping: "Spedizione", guide: "Guida", articles: "Articoli", faq: "FAQ" },
...
for (const locale of ["de", "fr", "es", "it"] as const) {
  const titles: Record<Locale, Record<PageKey, string>> = {
    ...
    de: { home: "Hacoo Produktlink-Atlas: IDs und Routenprüfung", spreadsheet: "Hacoo Produktlink-Tabelle: ID- und Routenprüfung", finds: "Aktuelle Hacoo-Produktlink-Prüfungen", categories: "Hacoo-Kategorierouten und Produkt-IDs", "qc-guide": "Hacoo QC-Fotoguide", shipping: "Hacoo Versandguide", guide: "Hacoo-Produktlinks verwenden", faq: "FAQ zur Hacoo-Linkprüfung", articles: "Hacoo Produktlink-Recherchen", "articles/find-product-links": "Aktuelle Hacoo-Produktlinks finden", "articles/read-qc-photos": "Hacoo-Bewertungen & QC-Fotos prüfen", "articles/size-before-you-buy": "Hacoo-Größenguide: vor dem Kauf messen" },
    ...
    es: { home: "Atlas de enlaces Hacoo: ID y rutas verificadas", spreadsheet: "Hoja de enlaces Hacoo: control de ID y rutas", finds: "Comprobaciones actuales de enlaces Hacoo", categories: "Rutas de categorías e ID de Hacoo", "qc-guide": "Guía de fotos QC Hacoo", shipping: "Guía de envío Hacoo", guide: "Cómo usar enlaces Hacoo", faq: "FAQ de verificación de enlaces Hacoo", articles: "Notas de investigación de enlaces Hacoo", "articles/find-product-links": "Cómo encontrar enlaces Hacoo actuales", "articles/read-qc-photos": "Reseñas Hacoo y fotos QC: guía de pruebas", "articles/size-before-you-buy": "Guía de tallas Hacoo: mide antes de comprar" },
