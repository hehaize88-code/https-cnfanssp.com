...
const de: SeoArticle[] = [
  {
    ...
    sections: [
      ...
      { id: "red-flags", heading: "Warnzeichen bei Hacoo Spreadsheets von Dritten", paragraphs: [
        ...
        "Weitere Warnzeichen sind versteckte Ziele, URL-Kürzer, kopierte Beschreibungen, identisches Lob in verschiedenen Kategorien und fehlende Aktualisierungsdaten. Gute Google-Platzierung ist kein Beweis für gute Belege. Prüfe das tatsächliche Ziel, bevor du Informationen eingibst oder zahlst. Dieser Index führt Suchen und Produktkarten klar zu CNFansSP, kennzeichnet seine Unabhängigkeit und hält die Prüfung sichtbar. Transparente Ziele und Eigentümersignale gehören zum Nutzen."
      ]},
...
const pt: SeoArticle[] = [
  {
    ...
    sections: [
      ...
      { id: "red-flags", heading: "Sinais de alerta em folhas Hacoo de terceiros", paragraphs: [
        ...
        "Outros sinais: destinos ocultos, URLs encurtados, textos copiados, elogios idênticos e falta de data. Um bom ranking Google não prova a qualidade da evidência. Verifique o destino antes de introduzir dados ou pagar. Este índice leva claramente à CNFansSP, declara a independência e mantém a verificação visível."
      ]},
