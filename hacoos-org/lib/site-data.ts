...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    sectionIntros: {
      spreadsheet: "Search the current live source catalogue or enter through a category. This independent navigation layer does not claim to be an official Hacoo spreadsheet.",
      finds: "An editorial cross-section of live source references. Every card keeps the destination visible and requires a current listing check.",
  ...
  de: {
    ...
    sectionIntros: { spreadsheet: "Durchsuche den aktuellen Live-Quellkatalog. Diese unabhängige Navigation behauptet nicht, ein offizielles Hacoo Spreadsheet zu sein.", finds: "Eine redaktionelle Auswahl aktiver Quellen mit sichtbarem Ziel und notwendiger Aktualitätsprüfung.", articles: "Vier unabhängige Hacoo-Langartikel mit datierten Belegen, getrennter Suchintention und vollständigen Sprachfassungen.", guides: "Ausführliche Notizen für überlegte Entscheidungen.", qc: "Ein wiederholbares System für Identität, Proportion, Maße, Material und Verarbeitung, ohne QC-Fotos für jeden Link zu versprechen.", shipping: "Keine Universalrate oder Lieferfrist wird als Fakt behauptet. Vergleiche aktuelles Angebot, Tracking und Gesamtkosten.", faq: "Was diese Seite ist, wohin Links führen und was du selbst prüfen musst." },
  },
  fr: {
